  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-roboto text-3xl text-center font-bold text-dark-soft md:text-4xl lg:text-left lg:max-w-[560px]">
          Read the most interesting articles
        </h1>
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-left">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur
          tenetur tempore ratione eaque expedita dicta distinctio pariatur iste
          enim, consectetur saepe aliquid dolor dolorem quos? Officiis
          necessitatibus ea placeat tenetur.
        </p>
